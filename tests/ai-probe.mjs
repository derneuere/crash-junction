  ...
  try {
    ...
    await page.evaluate(() => {
      ...
      const probe = {
        ...
        rivalWrecks: 0,
        playerCrashes: 0,
        playerRescues: 0, // probe-side stand-in for the (uncommitted) 5s rescue
      ...
      setInterval(() => {
        ...
        // the wall-blind driver can fly clean over a barrier; the branch this
        // probe targets predates the in-game 5s rescue, so stand in for it
    ...
    console.log(`player rescues      : ${probe.playerRescues} (probe stand-in for the 5s rescue)`);
